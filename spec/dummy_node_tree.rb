...
shared_context 'tree nodes' do
  ...
  before do
    ...
    @tree_current_indexes_with_footer = [0, 1, 4, 11, -11, 12, 22, -22, -12, -4, 5, -5, 6, 13, -13, -6, -1,
                                            2, 7, 14, -14, 15, 23, 31, -31, 32, 33, 34, -34, 35, -35, -33, -32, -23, 24, -24, 25, -25, -15, 16, -16, 17, -17, 18, 26, -26, 27, -27, -18, 19, -19, -7,
                                               8, 20, 28, -28, 29, -29, 30, -30, -20, -8, 9, -9, -2,
                                            3, 10, 21, -21, -10, -3,
                                         0]
  end
end
